...
- `<f.st`: The file is being transferred from the remote host to the local host (pushed).

- `>f.st`: The file is being transferred from the local host to the remote host (pulled).
